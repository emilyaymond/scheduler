...
Employee("B. Baker", 1,  donotschedule_list=["I. Warner"], marker=True),
    Employee("F. Clifford", 1),
    Employee("M. D'Agaro", 1),
    Employee("W. Ditta", 1),
    Employee("G. Ellias", 1),
    Employee("D. Fernandez", 1, marker=True),
    Employee("K. Fields", 1, donotschedule_list=["I. Warner"], marker=True),
    Employee("K. Franjieh", 1),
    Employee("J. Harty", 1),
    Employee("P. Mason", 1),
    Employee("J. Sherley", 1),
    Employee("M. Shore", 1),
    Employee("B. Sullivan", 1, marker=True),
    Employee("I. Warner", 1, donotschedule_list=["R. Mack"]),
    Employee("V. Volpi", 1, marker=True),
    Employee("E. Aymond", 2, donotschedule_list=["I. Warner", "V. Volpi"], marker=True),
    Employee("S. Boger", 2, marker=True),
    Employee("A. Corb", 2, marker=True),
    Employee("A. Corns", 2, marker=True),
    Employee("J. Dubovoy", 2, marker=True),
    Employee("A. Edwards", 2, marker=True),
    Employee("E. Gombos", 2, marker=True),
    Employee("S. Kamenetsky", 2, marker=True),
    Employee("B. Knepper", 2),
    Employee("Y. Lee", 2, donotschedule_list=["I. Warner"], marker=True),
    Employee("R. Mack", 2, donotschedule_list=["I. Warner"]),
    Employee("S. Ohtake", 2, marker=True),
    Employee("C. Paes", 2, marker=True),
    Employee("C. Rooke", 2, marker=True),
    Employee("T. Tewari", 2, donotschedule_list=["I. Warner"], marker=True),
    Employee("N. Aguirre", 2, donotschedule_list=["I. Warner"], marker=True),
    Employee("S. Amzallag", 3, marker=True),
    Employee("N. Anderson", 2, marker=True),
    Employee("I. Arnold", 2, marker=True),
    Employee("J. Avila", 3, marker=True),
    Employee("J. Barlia", 3, marker=True),
    Employee("A. Clark", 3),
    Employee("G. Finney", 3),
    Employee("C. Frankum", 3),
    Employee("A. Gasca", 3, marker=True),
    Employee("W. Harley", 3, marker=True),
    Employee("W. Heppding", 3),
    Employee("C. Ingram", 3),
    Employee("L. Kalish", 3),
    Employee("A. Lade", 3, marker=True),
    Employee("R. Lee", 3, marker=True),
    Employee("M. Montgomery", 3, marker=True),
    Employee("A. Ogbuefi", 2, marker=True),
    Employee("M. Parsons", 3, marker=True),
    Employee("B. Perez", 2),
    Employee("M. Pontoriero", 3),
    Employee("D. Ratner", 3),
    Employee("O. Sam", 3, marker=True),
    Employee("J. Seidel", 3),
    Employee("S. Snowman", 3),
    Employee("P. Strangways", 3),
    Employee("M. Tamanaha", 2, marker=True),
    Employee("I. Tandatnick", 3),
    Employee("D. Toydemir", 3, marker=True),
    Employee("O. White", 3),
    Employee("G. Willcutts", 3),
    Employee("M. Xie", 2, marker=True),
    Employee("K. Zelig", 3, marker=True)
]
